...
public class Paints {
	...
	// Colors
	public static Paint textPaint, white, red, darkBlue, lightBlue, lightGreen,
			darkGreen, yellow, grey, black, orange, purple, pink, silver1,
			silver2, blueT, redT, orangeT, yellowT, messagePaint, ep1, ep2,
			ep3, ep4, ep5, ep6, thrusters, lights, phasePaint;
	...
	public Paints() {
		...
		purple = new Paint();
		purple.setARGB(255, 51, 0, 51);
		purple.setTextSize(11);
		purple.setAntiAlias(true);
		pink = new Paint();
		pink.setARGB(255, 225, 0, 153);
		pink.setTextSize(11);
	...
	public void initalizeCustomColors(int lightColor, int expc1, int expc2,
			int expc3, int expc4, int expc5, int expc6, int thrust, int txtc) {
	...
	public void setPhasePaint() {

		phasePaint = new Paint();

		lights = phasePaint;
		messagePaint = phasePaint;
		thrusters = phasePaint;
	}

	public void updatePhasePaint() {

		phasePaint.setARGB(255, randomGen.nextInt(255), randomGen.nextInt(255),
				randomGen.nextInt(255));
		phasePaint.setTextSize(11);
		phasePaint.setAntiAlias(true);

	}

	public void randomizeExplosionColors() {

		int expc1 = randomGen.nextInt(10);
		int expc2 = randomGen.nextInt(10);
		int expc3 = randomGen.nextInt(10);
		int expc4 = randomGen.nextInt(10);
		int expc5 = randomGen.nextInt(10);
		int expc6 = randomGen.nextInt(10);
