...
public class HitGiantBossIndividualParts
{
   ...
   public void draw(Canvas canvas)
   {
	   ...
	   if(drawOutlines)
	   {
		   canvas.drawLine(x,y,x+width,y,MainGamePanel.greenPaint);
		   canvas.drawLine(x,y+height,x+width,y+height,MainGamePanel.greenPaint); 
		   canvas.drawLine(x,y,x,y+height,MainGamePanel.greenPaint);
		   canvas.drawLine(x+width,y,x+width,y+height,MainGamePanel.greenPaint);
		   canvas.drawLine(x,cy,cx,cy,MainGamePanel.greenPaint);
	   }
   ...
   {     
     if(enter&&x>MainGamePanel.deviceWidth-width)
          x-=5; 
     else 
         enter=false;
     ...
     if ((shipy-y)>120&&cy<MainGamePanel.deviceHeight/2)//&&Y<300)
         y+=3;
...
//     }
     ...
     if(attack==false&&x<MainGamePanel.deviceWidth-(width/2))   
          x+=1;
     // y-=1;
     // }
   ...
   {        
     ...
     if(enter&&x>MainGamePanel.deviceWidth-width)
       ...
       if ((shipy-y)>-80&&y+height<MainGamePanel.deviceHeight)//&&y<300)
         y+=3;
     else if ((shipy-y)<-120&&cy>MainGamePanel.deviceHeight/2)//&&y>100)
         y-=3;
...
//          x+=1;
   ...
   { 
     ...
     if(enter&&x>MainGamePanel.deviceWidth-width)
       ...
       if (((shipy-cy)>10)&&cy<MainGamePanel.deviceHeight-100)
         y+=2;
