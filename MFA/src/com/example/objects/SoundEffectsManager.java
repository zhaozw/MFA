...
public class SoundEffectsManager {
		...
		int exp1SID,exp2SID,exp3SID,laser1SID,laser2SID,laser3SID,shipHit1SID,shipHit2SID,shipHit3SID,nukeSID;
		
	    //what the used to trigger an explosion sound instead of using a boolean
		//ST for sound trigger//exp cycle for switching through the different 3 explosions objects
	    public int expST= -1;
		...
		int playKick;
	    boolean startMusic=false, stopMusic=false,musicPlaying=false,kickPlaying=false,stopKick=false;
			    ...
			    if(playerHitST==0){
		         ...
		         if(laserST==0)
		         {
		          ...
		          laserST = -1;
			    	 ...
			    	 switch(r){
			    	 case 0:
			    		 SP.play(laser1SID, 1, 1,0, 0,playBackRate); break;
			    	 case 1:
			    		 SP.play(laser2SID, 1, 1,0, 0,playBackRate); break;
			    	 case 2:
			    		 SP.play(laser3SID, 1, 1,0, 0,playBackRate); break;
			    	 }
			      }
			     ...
			     if(expST==0)
			     {
				    //play the clip and turn the trigger off
			    	 ...
			    	 switch(r){
			    	 case 0:
			    		 SP.play(exp1SID, 1, 1,0, 0,playBackRate);  break;
			    	 case 1:
			    		 SP.play(exp2SID, 1, 1,0, 0,playBackRate);  break;
			    	 case 2:
			    		 SP.play(exp3SID, 1, 1,0, 0,playBackRate);  break;
			    	 }
			      }
