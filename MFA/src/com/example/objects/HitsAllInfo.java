...
public class HitsAllInfo {
    ...
    public void initialize(HashMap map){
    	...
    	for(int k=0;k<3;k++){
    		if(k==0)
    			hitsInfo[setHits[k]].activationWave=randomGenerator.nextInt(1)+1;
    		else if(k==1)
    			hitsInfo[setHits[k]].activationWave=randomGenerator.nextInt(3)+2;
    		else if(k==2)
    			hitsInfo[setHits[k]].activationWave=randomGenerator.nextInt(3)+5;
    	}
    }
    ...
    public void createHit(int hit,Context context){
    	...
    	case(0):
    	      ...
    	      hit0.setImages(BitmapFactory.decodeResource(context.getResources(), R.drawable.eye100), BitmapFactory.decodeResource(context.getResources(), R.drawable.lj300), BitmapFactory.decodeResource(context.getResources(), R.drawable.uj300),BitmapFactory.decodeResource(context.getResources(), R.drawable.bullet));
    	 break; 
    	...
    	case(1):
    		  ...
    		  hit1 = new AsteroidHitSmall(BitmapFactory.decodeResource(context.getResources(), R.drawable.ag100), MGP.dp[7],MGP.dp[20],MGP.deviceWidth,MGP.deviceHeight);
    	 break;
    	...
    	case(2):
	          ...
	          hit2 = new AsteroidHitMedium(BitmapFactory.decodeResource(context.getResources(), R.drawable.ab165), MGP.dp[7],MGP.dp[20],MGP.deviceWidth,MGP.deviceHeight);
  		 
  	 break;
    	 case(3):
    		 Log.d("Hits All Info ", "creating hit 3");
    	   	flyingMessage.activate(1,(int) MGP.dp[3],hitsInfo[3].name+":  "+ hitsInfo[3].message);
    	  	hit3 = new AsteroidHitLarge(BitmapFactory.decodeResource(context.getResources(), R.drawable.ar250), MGP.dp[7],MGP.dp[20],MGP.deviceWidth,MGP.deviceHeight);
    		 
    	 break;
    	 case(4):

    		  Log.d("Hits All Info ", "creating hit 4");
    	 	flyingMessage.activate(1,(int) MGP.dp[3],hitsInfo[4].name+":  "+ hitsInfo[4].message);
	      	hit4 = new FollowAI(BitmapFactory.decodeResource(context.getResources(), R.drawable.tinyship1));
    	 ...
    	 case(6):
     	      ...
     	      flyingMessage.activate(1,(int) MGP.dp[3],hitsInfo[6].name+":  "+ hitsInfo[6].message);
     		
     	     hit6 = new Hit6(BitmapFactory.decodeResource(context.getResources(), R.drawable.icelarge), MGP.dp[15],MGP.dp[30],MGP.deviceWidth,MGP.deviceHeight);
     	 break;
    	 case(7):

     		  Log.d("Hits All Info ", "creating hit 7");
     	      flyingMessage.activate(1,(int) MGP.dp[3],hitsInfo[7].name+":  "+ hitsInfo[7].message);
     		
     	     hit7 = new Hit7(BitmapFactory.decodeResource(context.getResources(), R.drawable.icelarge), MGP.dp[15],MGP.dp[30],MGP.deviceWidth,MGP.deviceHeight);
     	 break;
    	 case(8):

     		  Log.d("Hits All Info ", "creating hit 8");
     	      flyingMessage.activate(1,(int) MGP.dp[3],hitsInfo[8].name+":  "+ hitsInfo[8].message);
     		
     	     hit8 = new Hit8(BitmapFactory.decodeResource(context.getResources(), R.drawable.icelarge), MGP.dp[15],MGP.dp[30],MGP.deviceWidth,MGP.deviceHeight);
     	 break;
    	 case(9):

     		  Log.d("Hits All Info ", "creating hit 9");
     	      flyingMessage.activate(1,(int) MGP.dp[3],hitsInfo[9].name+":  "+ hitsInfo[9].message);
     		
     	     hit9 = new Hit9(BitmapFactory.decodeResource(context.getResources(), R.drawable.icelarge), MGP.dp[15],MGP.dp[30],MGP.deviceWidth,MGP.deviceHeight);
     	 break;
    	 case(10):

     		  Log.d("Hits All Info ", "creating hit 10");
     	      flyingMessage.activate(1,(int) MGP.dp[3],hitsInfo[10].name+":  "+ hitsInfo[10].message);
     		
     	     hit10 = new Hit10(BitmapFactory.decodeResource(context.getResources(), R.drawable.icelarge), MGP.dp[15],MGP.dp[30],MGP.deviceWidth,MGP.deviceHeight);
     	 break;
    	 case(11):

     		  Log.d("Hits All Info ", "creating hit 11");
     	      flyingMessage.activate(1,(int) MGP.dp[3],hitsInfo[11].name+":  "+ hitsInfo[11].message);
     		
     	     hit11 = new Hit11(BitmapFactory.decodeResource(context.getResources(), R.drawable.icelarge), MGP.dp[15],MGP.dp[30],MGP.deviceWidth,MGP.deviceHeight);
     	 break;
    	 case(12):

     		  Log.d("Hits All Info ", "creating hit 12");
     	      flyingMessage.activate(1,(int) MGP.dp[3],hitsInfo[12].name+":  "+ hitsInfo[12].message);
     		
     	     hit12 = new Hit12(BitmapFactory.decodeResource(context.getResources(), R.drawable.icelarge), MGP.dp[15],MGP.dp[30],MGP.deviceWidth,MGP.deviceHeight);
     	 break;
    	 case(13):

     		  Log.d("Hits All Info ", "creating hit 13");
     	      flyingMessage.activate(1,(int) MGP.dp[3],hitsInfo[13].name+":  "+ hitsInfo[13].message);
     		
     	     hit13 = new Hit13(BitmapFactory.decodeResource(context.getResources(), R.drawable.icelarge), MGP.dp[15],MGP.dp[30],MGP.deviceWidth,MGP.deviceHeight);
     	 break;
    	 case(14):

    		  Log.d("Hits All Info ", "creating hit 14");
    	      flyingMessage.activate(1,(int) MGP.dp[3],hitsInfo[14].name+":  "+ hitsInfo[14].message);
    		
    	      hit14 = new Hit14(BitmapFactory.decodeResource(context.getResources(), R.drawable.icelarge), MGP.dp[15],MGP.dp[30],MGP.deviceWidth,MGP.deviceHeight);
    	 break;
    	 case(15):

    		  Log.d("Hits All Info ", "creating hit 15");
    	      flyingMessage.activate(1,(int) MGP.dp[3],hitsInfo[15].name+":  "+ hitsInfo[15].message);
    		
    	      hit15 = new Hit15(BitmapFactory.decodeResource(context.getResources(), R.drawable.icelarge), MGP.dp[15],MGP.dp[30],MGP.deviceWidth,MGP.deviceHeight);
    	 break;
      }
 ...
 public void DrawMessage(Canvas canvas){
   ...
   public void DrawHits(Canvas canvas){
		...
		for(int k=0;k<3;k++){
			canvas.drawText("hit "+ setHits[k] +" "+hitsInfo[setHits[k]].name+" activation Wave "+hitsInfo[setHits[k]].activationWave,0,(k+1)*10+10,MGP.orangePaint);
		}
