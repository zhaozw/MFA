...
public class Hits extends FragmentActivity {
	...
	public class SectionsPagerAdapter extends FragmentStatePagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			case 0:
				...
				hits_0_Bundle.putInt(hits_0_menu.ARG_SECTION_NUMBER,
						position + 1);
			...
			case 1:
				...
				hits_1_Bundle.putInt(hits_1_menu.ARG_SECTION_NUMBER,
						position + 1);
			...
			case 2:
				...
				hits_2_Bundle.putInt(hits_2_menu.ARG_SECTION_NUMBER,
						position + 1);
			...
			case 3:
				...
				hits_3_Bundle.putInt(hits_3_menu.ARG_SECTION_NUMBER,
						position + 1);
			...
			case 4:
				...
				hits_4_Bundle.putInt(hits_4_menu.ARG_SECTION_NUMBER,
						position + 1);
			...
			case 5:
				...
				hits_5_Bundle.putInt(hits_5_menu.ARG_SECTION_NUMBER,
						position + 1);
			...
			case 6:
				...
				hits_6_Bundle.putInt(hits_6_menu.ARG_SECTION_NUMBER,
						position + 1);
			...
			case 7:
				...
				hits_7_Bundle.putInt(hits_7_menu.ARG_SECTION_NUMBER,
						position + 1);
			...
			case 8:
				...
				hits_8_Bundle.putInt(hits_8_menu.ARG_SECTION_NUMBER,
						position + 1);
			...
			case 9:
				...
				hits_9_Bundle.putInt(hits_9_menu.ARG_SECTION_NUMBER,
						position + 1);
			...
			case 10:
				...
				hits_10_Bundle.putInt(hits_10_menu.ARG_SECTION_NUMBER,
						position + 1);
			...
			case 11:
				...
				hits_11_Bundle.putInt(hits_11_menu.ARG_SECTION_NUMBER,
						position + 1);
			...
			case 12:
				...
				hits_12_Bundle.putInt(hits_12_menu.ARG_SECTION_NUMBER,
						position + 1);
			...
			case 13:
				...
				hits_13_Bundle.putInt(hits_13_menu.ARG_SECTION_NUMBER,
						position + 1);
			...
			case 14:
				...
				hits_14_Bundle.putInt(hits_14_menu.ARG_SECTION_NUMBER,
						position + 1);
			...
			case 15:
				...
				hits_15_Bundle.putInt(hits_15_menu.ARG_SECTION_NUMBER,
						position + 1);
	...
	public static class hits_0_menu extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View rootView = inflater.inflate(R.layout.activity_hit0_menu,
					container, false);
			TextView dummyTextView = (TextView) rootView
					.findViewById(R.id.selection_label);
	...
	public static class hits_1_menu extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
				Bundle savedInstanceState) {
			View rootView = inflater.inflate(R.layout.activity_hit1_menu,
					container, false);
			TextView dummyTextView = (TextView) rootView
					.findViewById(R.id.selection_label);
			dummyTextView.setText("");
	...
	public static class hits_2_menu extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
				Bundle savedInstanceState) {
			View rootView = inflater.inflate(R.layout.activity_hit2_menu,
					container, false);
			TextView dummyTextView = (TextView) rootView
					.findViewById(R.id.selection_label);
			dummyTextView.setText("");
	...
	public static class hits_4_menu extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
				Bundle savedInstanceState) {
			View rootView = inflater.inflate(R.layout.activity_hit4_menu,
					container, false);
			TextView dummyTextView = (TextView) rootView
					.findViewById(R.id.selection_label);
			dummyTextView.setText("");
	...
	public static class hits_5_menu extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
				Bundle savedInstanceState) {
			View rootView = inflater.inflate(R.layout.activity_hit5_menu,
					container, false);
			TextView dummyTextView = (TextView) rootView
					.findViewById(R.id.selection_label);
			dummyTextView.setText("");
	...
	public static class hits_6_menu extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
				Bundle savedInstanceState) {
			View rootView = inflater.inflate(R.layout.activity_hit6_menu,
					container, false);
			TextView dummyTextView = (TextView) rootView
					.findViewById(R.id.selection_label);
			dummyTextView.setText("");
